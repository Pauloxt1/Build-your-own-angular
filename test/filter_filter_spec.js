...
describe("filter filter", function(){
  ...
  it("filters an array of objects where any values matches", function(){
     var fn = parse('arr | filter:"o"');
     expect(fn({arr: [
  ...
  it("filters an array of objects where a nested valeu matches", function(){
    var fn = parse('arr | filter:"o"');
    expect(fn({arr: [
  ...
  it("filters nested objects on the same level only", function(){
    var items = [
      {user: 'Bob'},
      {user:{name: 'Bob'}},
  ...
  it("allows using a custom comparator", function(){
    ...
    expect(fn({
      arr:['o','oo','ao','aa'],
      myComparator: function(actual, expected){
