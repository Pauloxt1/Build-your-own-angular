...
describe("parse", function(){
  ...
  it("can parse scientific notation with negative expoents", function(){
  ...
  it("will parse a empty object", function(){
    var fn = parse('{}');
    expect(fn()).toEqual({});
  });
  ...
  it("will parse an object with indentifier keys", function(){
  ...
  it("does not allow assing window", function(){
  ...
  it("does not allow refercing window", function(){
    var fn = parse('wnd');
    expect(function(){
      fn({wnd: window});
    }).toThrow();
  ...
  it("parses a relational operators", function(){
  ...
  it("parses additives on higher precedence than relationals", function(){
  ...
  it("returns the function itself when give one", function(){
    var fn = function(){};
  ...
  it("marks indentifers non-constants", function(){
    var fn = parse('a');
    expect(fn.constant).toBe(false);
  });

  it("marks arrays constants when elements are constant", function(){
  ...
  it('marks this a non-constant', function(){
  ...
  it("marks assignments constants when both sides are", function(){
  ...
  it("marks binares constant when both arguments are constant", function(){
    expect(parse('1 + 2').constant).toBe(true);
