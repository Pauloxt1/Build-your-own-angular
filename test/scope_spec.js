...
describe("Scope", function(){
  ...
  describe("Digest", function(){
    ...
    it("may haver watchers that omit the listener function", function(){
      var watchFn = jasmine.createSpy();
      scope.$watch(watchFn);
      scope.$digest();
    ...
    it("compares based on value if enblaed", function(){
      scope.aValue = [1,2,3];
      scope.counter = 0;
    ...
    it("does not inclued $$postDigest in the digest", function(){
    ...
    it("caches exceptions in $applyAsync", function(done){
    ...
    it("caches exceptions in $$postDigest", function(){
      var didRun = false;
    ...
    it("removes constant watches after invocation", function(){
    ...
    it("removes one-time watchers after the first invocation", function(){
      scope.aValue = 42;
    ...
    it("does not removal one-time-watches until value is defined", function(){
      scope.$watch('::aValue', function(){});
  ...
  describe('$watchGroup', function(){
      ...
      it('uses diferent arrays for old and new values on subsequet runs', function(){
        var gotNewValues, gotOldValues;
      ...
      it('can be deregistred', function(){
        var counter = 0;
      ...
      it('does not call the zero-watch listern when deregistred fisrt', function(){
        var counter = 0;
  ...
  describe("inheritance", function(){
    ...
    it("can manipulete a parent scope's property", function(){
      var parent = new Scope();
      var child = parent.$new();
      parent.aValue = [1,2,3];
    ...
    it("shadows a parent's property with the same name", function(){
      ...
      expect(parent.name).toBe('Paulo');
      expect(child.name).toBe('batata');
    });

    it("does not shadow members of parent's scope attributes", function(){
      var parent = new Scope();
      var child = parent.$new();

      parent.user = {name: 'Paulo'};
      child.user.name = 'batata';

      expect(parent.user.name).toBe('batata');
      expect(child.user.name).toBe('batata');
    });
    ...
    it("shecdules a digest from root on $evalAsync", function(done){
      var parent = new Scope();
      var child = parent.$new();
      var child2 = child.$new();
    ...
    it("is no long digested when $destroy has been called", function(){
      var parent = new Scope();
      var child = parent.$new();
  ...
  describe("$watchCollection", function(){
    ...
    it("noticies an item added to an array", function(){
      scope.arr = [1,2,3];
      scope.counter = 0;
    ...
    it("noticies an item removed from an array", function(){
      scope.arr = [1,2,3];
      scope.counter = 0;
    ...
    it("noticies an item replaced in array", function(){
      scope.arr = [1,2,3];
      scope.counter = 0;
    ...
    it("notices item reordered in array", function(){
      scope.arr = [2,1,3];
      scope.counter = 0;
    ...
    it('does not fail on NaNs in arays', function(){
      scope.arr = [2,NaN,4];
      scope.counter = 0;
    ...
    it("noticies when a value becomes an object", function(){
      scope.counter = 0;
    ...
    it("noticies when an attribute is added an object", function(){
      scope.counter = 0;
      scope.obj = {a: 1};
    ...
    it("noticies when an attribute is changed an object", function(){
      scope.counter = 0;
      scope.obj = {a: 1};
    ...
    it("noticies when an attribute is removed from a object", function(){
      scope.counter = 0;
      scope.obj = {a:1};
    ...
    it("uses the new value as the old value in the first digest", function(){
      scope.aValue = {a:1, b:2};
      var oldValueGiven;
  ...
  describe("Events", function(){
    ...
    _.forEach(['$emit', '$broadcast'], function(method){
        ...
        it("can be deregistred "+method, function(){
          var listener = jasmine.createSpy();
        ...
        it("is seted defaultPrevented when preventDefault called on "+method, function(){
    ...
    it("is recived by listeners on current scope after begin stopped", function(){
      var listener1 = function(event){
        event.stopPropagation();
      };
      var listener2 = jasmine.createSpy();
